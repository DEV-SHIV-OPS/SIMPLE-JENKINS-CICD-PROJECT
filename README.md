...
-------
    git clone https://github.com/shivam123/spring-cloud-kubernetes.git
...
--------------
    docker build -t shivam123/kubernetes-configmap-reload .
...
-----------
    docker push shivam123/kubernetes-configmap-reload
